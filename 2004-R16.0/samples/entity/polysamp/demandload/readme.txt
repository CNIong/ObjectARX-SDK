...
Demand Loading PolySamp/PolyCAD 2002
...
Execute these tasks in order first:
  ...
  1. Using a text editor, update polysamp.reg.
     ...
     Install ID now uses the country code. Change "ACAD-201:409" in the registry
     ...
     [HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\AutoCAD\R16.0\ACAD-201:409\Applications\AsdkPolyCAD]
...
I. Command Invocation
     ...
     [HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\AutoCAD\R16.0\ACAD-201:409\Applications\AsdkPolyCAD\Commands]
     "ASDK_POLY"="POLY"
  ...
  3. Invoking the command POLY defined in polyui.arx will Demand
     ...
     [HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\AutoCAD\R16.0\ACAD-201:409\Applications\AsdkPolyCAD\Groups]
