...
void
ArxDbgEditorReactor::unknownCommand(const char* cmdStr, AcDbVoidPtrArray *al)
{
    CString str;
...
void
ArxDbgEditorReactor::commandWillStart(const char* cmdStr)
{
    CString str;
...
void
ArxDbgEditorReactor::commandEnded(const char* cmdStr)
{
    CString str;
...
void
ArxDbgEditorReactor::commandCancelled(const char* cmdStr)
{
    CString str;
...
void
ArxDbgEditorReactor::commandFailed(const char* cmdStr)
{
    CString str;
...
void
ArxDbgEditorReactor::lispWillStart(const char* firstLine)
{
    CString str;
...
/****************************************************************************
**
**  ArxDbgEditorReactor::beginClose
**
**  **jma
**
*************************************/
...
void
ArxDbgEditorReactor::beginClose(AcDbDatabase* db)
{
    printReactorMessage(_T("Begin Close"), db);
}
...
void
ArxDbgEditorReactor::beginDwgOpen(char* filename)
{
    CString str;
...
void
ArxDbgEditorReactor::endDwgOpen(const char* filename)
{
    CString str;
...
void
ArxDbgEditorReactor::dwgFileOpened(AcDbDatabase* db, char* fileName)
{
    CString str;
...
void
ArxDbgEditorReactor::beginSave(AcDbDatabase* db, const char* pIntendedName)
{
    CString str;
...
void
ArxDbgEditorReactor::saveComplete(AcDbDatabase* db, const char* pActualName)
{
    CString str;
...
void
ArxDbgEditorReactor::beginInsert(AcDbDatabase* pTo, const char* pBlockName, AcDbDatabase* pFrom)
{
    CString str;
...
void
ArxDbgEditorReactor::sysVarWillChange(const char* varName)
{
    CString str;
...
void
ArxDbgEditorReactor::beginAttach(AcDbDatabase* pTo, const char* pName, AcDbDatabase* pFrom)
{
    CString str;
...
void
ArxDbgEditorReactor::beginRestore(AcDbDatabase* pTo, const char*, AcDbDatabase* pFrom)
{
...
void
ArxDbgEditorReactor::xrefSubcommandAttachItem(AcDbDatabase* pHost, int activity, const char* pPath)
{
    CString str, str2;
    LPCTSTR tmpStr;
...
void
ArxDbgEditorReactor::xrefSubcommandOverlayItem(AcDbDatabase* pHost, int activity, const char* pPath)
{
    CString str, str2;
...
void
ArxDbgEditorReactor::layoutSwitched(const char* newLayoutName)
{
    CString str;
...
void
ArxDbgEditorReactor::modelessOperationWillStart(const char* contextStr)
{
...
void
ArxDbgEditorReactor::modelessOperationEnded(const char* contextStr)
{
