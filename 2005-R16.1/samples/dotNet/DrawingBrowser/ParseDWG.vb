...
Module ParseDWG
    ...
    Public Function fillIcons(ByRef tree As TreeView)
    ...
    Function ExtractObjectInfo(ByVal rootNode As System.Windows.Forms.TreeNode, ByVal obj As Object)
        ...
        Try
            ...
            If iList.Contains(wrapper.UnmanagedObject) Then Exit Function
