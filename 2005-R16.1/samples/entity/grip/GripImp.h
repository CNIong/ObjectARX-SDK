...
typedef std::map<const char*,int>::value_type grip_type;

typedef std::map<AcDbGripOperations::GripStatus,const char*> GripStatus;
typedef std::map<AcDbGripOperations::GripStatus,const char*>::value_type GripStatus_type;
