...
HKLM\SOFTWARE\Autodesk\ObjectDBX\R16.1\Applications\AsdkPolyObj

and

HKLM\SOFTWARE\Autodesk\ObjectDBX\R16.0\Applications\AsdkPolyObj

Note:  This is done to support 2004 versions of polyobj's which can be opened in the 2005 editor.  Since the DBX will be binary compatible with 2004, this is fine to do.  Generally, you will want to distribute each specific version of the binaries within the installer...i.e. cumulatively.
