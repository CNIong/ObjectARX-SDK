...
void initApp()
{
    ...
    AsdkCustomWorldDraw::rxInit();
    AsdkCustomContext::rxInit();
    AsdkCustomWorldGeometry::rxInit();
    AsdkCustomSubEntityTraits::rxInit();
...
extern "C" AcRx::AppRetCode acrxEntryPoint( AcRx::AppMsgCode msg, void* pkt)
{
    ...
    case AcRx::kUnloadAppMsg:
        ...
        deleteAcRxClass(AsdkCustomWorldDraw::desc()); 
        deleteAcRxClass(AsdkCustomContext::desc()); 
        deleteAcRxClass(AsdkCustomWorldGeometry::desc()); 
        deleteAcRxClass(AsdkCustomSubEntityTraits::desc());
